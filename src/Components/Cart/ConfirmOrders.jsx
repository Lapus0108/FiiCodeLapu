...
export default class ConfirmSale extends Component {
    ...
    notSold=() =>{
        axiosRequest.post("orders/" + this.props.match.params.id + "/devalidate")
                        ...
                        <div class="col">
                            <div className="container_agree_transaction">
                                {this.state.confirmed === 1 ?
                                    ...
                                    <div className="container_butoane_agree_transaction">
                                        <div class="row justify-content-center">
                                            <div class="col xs-4 xl-4 text-right"><button >Yes</button></div>
                                            <div class="col xs-4 xl-4 "><button >Not yet</button></div>
